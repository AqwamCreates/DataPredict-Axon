...
function ActivationFunctions.Sigmoid(tensor)
...
function ActivationFunctions.BinaryStep(tensor)
...
function ActivationFunctions.RectifiedLinearUnit(tensor)
...
function ActivationFunctions.LeakyRectifiedLinearUnit(tensor, negativeSlopeFactor)
	
	negativeSlopeFactor = negativeSlopeFactor or 0.01
...
function ActivationFunctions.ExponentLinearUnit(tensor, negativeSlopeFactor)
...
function ActivationFunctions.SigmoidLinearUnit(tensor)
...
function ActivationFunctions.Gaussian(tensor)
...
function ActivationFunctions.Mish(tensor)
...
function ActivationFunctions.Tanh(tensor)
...
function ActivationFunctions.Softmax(tensor, dimension)
